...
struct x86_thread_report_stack_t
{
	...
	long long interthread_penalty_cycles;
...
struct x86_thread_t
{
	...
	struct linked_list_t *aq; /* Queue with the accessing loads and stores */
	...
	long long aq_occupancy;
	long long aq_full;
	long long aq_reads;
	long long aq_writes;
	long long aq_wakeup_accesses;
	...
	struct list_t **reachable_modules_per_level;
...
struct x86_core_t
{
	...
	/* Stats */
	long long dispatch_stall[x86_dispatch_stall_max];
	long long interthread_penalty_cycles; /* Cicles with the ROB stalled due interferences from other threads */
