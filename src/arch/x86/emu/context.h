...
struct x86_ctx_report_stack_t
{
	...
	long long interthread_cache_penalty_cycles;
	long long interthread_dram_penalty_cycles;
	...
	long long *accesses_per_level_int;
	long long *evictions_per_level_int;
	long long *late_prefs_per_level_int;
	long long *atd_hits_per_level_int;
	long long *atd_misses_per_level_int;
	long long *atd_unknown_per_level_int; /* The access is to a set not present in the ATD due space constraints */
	long long *atd_accesses_per_level_int;
	long long *atd_intramisses_per_level_int; /* Misses inherent to the thread */
	long long *atd_intermisses_per_level_int; /* Misses 'caused by other thread '*/
	long long *atd_cm_ah_per_level_int;
	long long *atd_ch_am_per_level_int;
...
struct x86_ctx_t
{
	...
	long long num_committed_inst;
	long long num_committed_uinst;

	/* Number of executed instructions.
	 * Updated by the emulator. */
