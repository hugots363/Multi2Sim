...
/* Network switching */
extern char *network_switching_map[];
extern enum network_switching_t
{
	network_switching_saf = 0,
	network_switching_vct
} network_switching;
...
struct net_t
{
	/* Properties */
	char *name;
	enum network_switching_t switching;
...
void net_receive_frag(struct net_t *net, struct net_node_t *node,
		struct net_msg_frag_t *frag);
void net_receive_msg(struct net_t *net, struct net_node_t *node,
		struct net_msg_t *frag);
